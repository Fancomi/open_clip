...
# GPU8 - BS512 - 10Epoch - Best LR: 2.8e-4 . ln(4096)+1 = 9.3177661667
GPUS=8
PreGpuBS=512
...
LR_12_1=$(python3 -c "print($LR * 1.2)")
LR_15_1=$(python3 -c "print($LR * 1.5)")
LR_17_1=$(python3 -c "print($LR * 1.7)")
LR_20_1=$(python3 -c "print($LR * 2.0)")
LR_25_1=$(python3 -c "print($LR * 2.5)")
LR_1_100=$(python3 -c "print($LR / 100)")
LR_1_50=$(python3 -c "print($LR / 50)")
LR_1_10=$(python3 -c "print($LR / 10)")
LR_1_5=$(python3 -c "print($LR / 5)")
